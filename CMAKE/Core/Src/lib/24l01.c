...
// 	GPIO_InitStructure.Pin = GPIO_PIN_12;				 //PB12上拉 防止W25X的干扰
//  	GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP; 		 //推挽输出
//  	GPIO_InitStructure.Speed = GPIO_Speed_50MHz;
//  	HAL_GPIO_Init(GPIOB, &GPIO_InitStructure);	//初始化指定IO
//  	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_12, GPIO_PIN_SET);//上拉				
 	

// 	GPIO_InitStructure.Pin = GPIO_PIN_7|GPIO_PIN_8;	//PG8 7 推挽 	  
//  	HAL_GPIO_Init(GPIOG, &GPIO_InitStructure);//初始化指定IO
  
// 	GPIO_InitStructure.Pin  = GPIO_PIN_6;   
// 	GPIO_InitStructure.Mode = GPIO_MODE_IPD; //PG6 输入  
